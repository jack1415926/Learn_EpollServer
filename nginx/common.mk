...
#%.o:%.c
$(LINK_OBJ_DIR)/%.o:%.cxx
# 【修改3】：增加 -I/usr/local/include，帮助编译器找到 sw/redis++/redis++.h
	$(CC) -I$(INCLUDE_PATH) -I/usr/local/include -o $@ -c $(filter %.cxx,$^)
#----------------------------------------------------------------2end-------------------
...
# 【修改4】：依赖文件生成同样需要引入 include 路径
	$(CC) -I$(INCLUDE_PATH) -I/usr/local/include -MM $^ >> $@
